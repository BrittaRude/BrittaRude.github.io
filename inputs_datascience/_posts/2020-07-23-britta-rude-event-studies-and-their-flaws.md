...
[Rambach and Roth (2019)](https://scholar.harvard.edu/files/jroth/files/roth_jmp_honestparalleltrends_main.pdf)'s approach is based on the assumption that the difference in pre-trends is based on some pre-specified class $$ \triangle $$, and imposes smoothness restrictions. The authors recommend to conduct sensitivity analysis with respect to the linearlity assumption in differential trends. Through these sensitivity analyses researchers can then deduce conditions under which certain conclusions hold. 
...
For flaws in Event Studies with varying treatment, see the paper by [Sun and Abraham (2020)](http://economics.mit.edu/files/14964) which I resume in my [next blogpost](https://brittarude.github.io/blog/2020/07/26/britta-rude-event-studies-dynamic-treatment). 
